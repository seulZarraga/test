//=============== init autocomplete =============================
          ...
          function searchCallback(err, content) {
              ...
              for (var i = 0; i < content.hits.length; ++i) {
                res += '<div class="result-header-item">'
                res += '<a href="'+content.hits[i].product_url+'">'
                res += '<div class="itemheader">'
                res += '<div class="col-md-3">'
                res += '<img src="' + content.hits[i].product_image_url + '"  class="img-responsive">'
                res += '</div>'
                res += '<div class="col-md-9"><h4>' + content.hits[i]._highlightResult.product_name.value +'</h4></div>'
                res += '</div>'
                res += '</a>'
                res += '</div>'
